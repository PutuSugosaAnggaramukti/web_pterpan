    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <br>
                    <form action="/beasiswa/tambah" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                                <label for="harga">IPS</label>
                                <input class="form-control" type="text" name="ips">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleJenisTes">Jenis Beasiswa</label>
                            <br>
                            <select name="informasi_id" id="exampleJenisTes">
                                @foreach ($data_informasi as $informasi)
                                    <option class="form-control" value={{$informasi->id}}>{{$informasi->nama_beasiswa}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                                <label for="gambar">Transkrip</label>
                                <input class="form-control" type="file" name="transkrip">
                        <div class="form-group">
                        <div class="form-group">
                                <label for="gambar">Surat Rekomendasi</label>
                                <input class="form-control" type="file" name="surat_rekomen">
                        <div class="form-group">
