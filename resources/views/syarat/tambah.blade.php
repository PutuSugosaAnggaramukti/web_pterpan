    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                <h1>Input Informasi Beasiswa</h1>
                <br>
                    <form action="/syarat/tambah" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                                <label for="harga">Semester</label>
                        ...
                        <div class="form-group">
                                <label for="harga">syarat_lain</label>
                                <input class="form-control" type="text" name="syarat_lain">
                        </div>
                        <div class="form-group">
                                <label for="gambar">Unggah File</label>
